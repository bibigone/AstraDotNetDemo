...
{
    /// <summary>
    /// Helper buffer for infrared  data. For details see description of base class.
    /// </summary>
    internal sealed class InfraredBuffer : Buffer<short>
    {        
        ...
        public InfraredBuffer(Dispatcher dispatcher, int width, int height)
            : base(dispatcher, width, height, PixelFormat, BytesPerPixel, PixelFormats.Rgb24)
        { }
